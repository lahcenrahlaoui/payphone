...
abstract class ProgressCircleIndicator extends Control {
    ...
    public void setProgress(int progressValue) {
        progress.set(num(progressValue));
...
//   defaultToHundred   ===   num
    private int num(int value) { /// hello rani mbedel hna hadik ta3 value >= con......
        if (value >= Client.circleTime) {
            return Client.circleTime;
        }
        return value;
    }
